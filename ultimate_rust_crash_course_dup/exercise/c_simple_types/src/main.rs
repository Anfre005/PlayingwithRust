...
fn main() {
    ...
    //
    //MY NOTES: the coord here is a Tuple.
    ...
    //
    let coords_arr: [f32;2] = [20.0, 13.0];            // create an array literal out of parts of `coord` here
    ...
    let mess: ([i32; 2], f32, [(bool,i16);2], i8, &str) = ([3, 2], 3.14, [(false, -3), (true, -100)], 5, "candy");
